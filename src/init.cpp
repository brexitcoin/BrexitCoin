...
std::string HelpMessage()
{
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 7511 or testnet: 25714)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 7512 or testnet: 25715)") + "\n";

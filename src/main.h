...
static const int64_t MAX_MONEY = 494117647 * COIN;
...
inline int64_t FutureDrift(int64_t nTime, bool fProofOfStake=false) { return nTime + (fProofOfStake ? stakeDrift : workDrift); }

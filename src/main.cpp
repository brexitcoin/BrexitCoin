...
static const unsigned int DEFAULT_BLOCK_MIN_SIZE = 0; // 0 bytes
...
int64_t GetStormnodePayment(int64_t blockValue);
...
bool AcceptableInputs(CTxMemPool& pool, CValidationState &state, const CTransaction &tx, bool fLimitFree,
                        bool* pfMissingInputs, bool fRejectInsaneFee=false, bool isSSTX=false);

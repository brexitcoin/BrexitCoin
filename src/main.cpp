...
#if defined(NDEBUG)
# error "Brexit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Brexit Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	if(pindexBest->nHeight == 0) { nSubsidy = 74117647 * COIN; }
